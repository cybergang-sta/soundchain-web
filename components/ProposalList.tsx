...
export default function ProposalList({ proposals }: { proposals: Proposal[] }) {
  return (
    <div className="rounded-2xl border border-hairline bg-surface p-[26px]">
      <div className="mb-5 text-[13px] font-semibold text-smoke">Active &amp; recent proposals</div>
      <div className="flex flex-col gap-5">
        {proposals.map((p) => (
          <div key={p.title} className="border-b border-hairline pb-5 last:border-b-0 last:pb-0">
            ...
            <div className="flex items-center justify-between text-[11.5px] text-smoke">
